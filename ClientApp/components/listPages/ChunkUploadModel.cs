...
{
    /// <summary>
    /// Corrresponds to config settings to be passed to //https://github.com/TTLabs/EvaporateJS/wiki/Evaporate.create()
    /// </summary>
    public class ChunkUploadModel
    {
        public bool usings3 { get; set; } = false;
        public bool usingazure { get; set; } = false;
