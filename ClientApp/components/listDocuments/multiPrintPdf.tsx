...
const tooltip = <Tooltip id='tooltip'>Print Multi PDF</Tooltip>;
const label = (
  ...
  <li>
    <div style={{ float: 'left', paddingRight: '5px' }}>
      <ToggleButton
        ...
        value={!!selectableSettings['multiPrintPdf']}
        thumbStyle={borderRadiusStyle}
        trackStyle={borderRadiusStyle}
        onToggle={(value) => {
          //remeber to add to mainnav/reducer.t =s :settingsToPersist if you want setting to persist
          dispatch(ensureMainNav().updateSetting('multiPrintPdf', !value));
        }}
      />
    </div>
    <span>Multi Print-pdf</span>
  </li>
);
